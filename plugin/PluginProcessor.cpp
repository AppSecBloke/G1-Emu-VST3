...
bool G1PluginProcessor::loadPatch(const juce::File& f,juce::String& error){
 ...
 // Give a newly-created machine time to finish booting, then perform the same NME greeting/init used by upstream g1patchtest.
