...
private: void timerCallback() override; G1PluginProcessor& proc; juce::TextButton choose{"Choose ROM..."}; juce::Label title, rom, status, diag; std::unique_ptr<juce::FileChooser> chooser;
};
